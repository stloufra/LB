...
#ifndef COLLISIONCUMD3Q27TURBULENTCOMBINED_H
#define COLLISIONCUMD3Q27TURBULENTCOMBINED_H

#include "../../traits/LBMTraits.h"

template<typename MODELDATA>
struct CollisionCumD3Q27TurbulentCombined {
    ...
    static void collision(LBMDataPointer &Data, LBMConstantsPointer &Constants) {
        ...
        mutable
        {
            ...
            // implementation of M.Geiger 2017
            ...
            const RealType lambda3 = 0.01f; // Section 7 @ Geier 2017
            const RealType lambda4 = 0.01f; //
            const RealType lambda5 = 0.01f; //

            const RealType omega3 = 8.f * (omega1 - 2.f) * (omega2 * (3.f * omega1 - 1.f) - 5.f * omega1) /
                                    (8.f * (5.f - 2.f * omega1) * omega1 +
                                     omega2 * (8.f + omega1 * (9.f * omega1 - 26.f)));

            const RealType omega120p102 =
                    omega3 + (1.f - omega3) * fabs(C_120 + C_102) / (rho * lambda3 + fabs(C_120 + C_102)); // limiter
            const RealType omega210p012 =
                    omega3 + (1.f - omega3) * fabs(C_120 + C_102) / (rho * lambda3 + fabs(C_120 + C_102)); // limiter
            const RealType omega201p021 =
                    omega3 + (1.f - omega3) * fabs(C_201 + C_021) / (rho * lambda3 + fabs(C_201 + C_021)); // limiter

            const RealType omega4 = 8.f * (omega1 - 2.f) * (omega1 + omega2 * (3.f * omega1 - 7.f)) /
                                    (omega2 * (56.f - 42.f * omega1 + 8.f * omega1 * omega1) - 8.f * omega1);

            const RealType omega120m102 =
                    omega4 + (1.f - omega4) * fabs(C_120 - C_102) / (rho * lambda4 + fabs(C_120 - C_102)); // limiter
            const RealType omega210m012 =
                    omega4 + (1.f - omega4) * fabs(C_120 - C_102) / (rho * lambda4 + fabs(C_120 - C_102)); // limiter
            const RealType omega201m021 =
                    omega4 + (1.f - omega4) * fabs(C_201 - C_021) / (rho * lambda4 + fabs(C_201 - C_021)); // limiter

            const RealType omega5 = 24.f * (omega1 - 2.f) *
                                    ...
                                    (16.f * omega1 * omega1 * (omega1 - 6.f) -
                                     ...
                                     omega2 * omega2 *
                                     (omega1 * (3.f * omega1 - 10.f) * (15.f * omega1 - 28.f) - 48.f));

            const RealType omega111 = omega5 + (1.f - omega5) * fabs(C_111) / (rho * lambda5 + fabs(C_111)); // limiter
            ...
            const RealType A = (4.f * omega1 * omega1 + 2.f * omega1 * omega2 * (omega1 - 6.f) +
                                omega2 * omega2 * (omega1 * (10.f - 3.f * omega1) - 4.f)) / (omega1 - omega2) /
                               (omega2 * (2.f + 3.f * omega1) - 8.f * omega1);
            const RealType B = (4.f * omega1 * omega2 * (9.f * omega1 - 16.f) - 4.f * omega1 * omega1 -
                                2.f * omega2 * omega2 * (2.f + 9.f * omega1 * (omega1 - 2.f))) / 3.f /
            ...
            //G2017
            const RealType DxvDyu = -3.f * omega1 / rho * C_110;
            const RealType DxwDzu = -3.f * omega1 / rho * C_101;
            const RealType DywDzv = -3.f * omega1 / rho * C_011;
            ...
            const RealType Eq119 = (1.f - omega201p021) * (C_201 + C_021);
            const RealType Eq120 = (1.f - omega120m102) * (C_120 - C_102);
            const RealType Eq121 = (1.f - omega210m012) * (C_210 - C_012);
            const RealType Eq122 = (1.f - omega201m021) * (C_201 - C_021);

            const RealType Cs_120 = 0.5f * (Eq120 + Eq117);
            const RealType Cs_102 = 0.5f * (-Eq120 + Eq117);
            const RealType Cs_210 = 0.5f * (Eq121 + Eq118);
            const RealType Cs_012 = 0.5f * (-Eq121 + Eq118);
            const RealType Cs_021 = 0.5f * (-Eq122 + Eq119);
            const RealType Cs_201 = 0.5f * (Eq122 + Eq119);

            //Eq G2017(42)
            const RealType Cs_111 = (1.f - omega111) * C_111;

            //Eq G2017(43, 44, 45) 
            const RealType Eq43RHS = 2.f / 3.f * (1.f / omega1 - 0.5f) * omega6 * A * rho * (Dxu - 2.f * Dyv + Dzw) +
                                     (1.f - omega6) * (C_220 - 2.f * C_202 + C_022);
            const RealType Eq44RHS = 2.f / 3.f * (1.f / omega1 - 0.5f) * omega6 * A * rho * (Dxu + Dyv - 2.f * Dzw) +
                                     (1.f - omega6) * (C_220 + C_202 - 2.f * C_022);
            const RealType Eq45RHS = -4.f / 3.f * (1.f / omega1 - 0.5f) * omega7 * A * rho * (Dxu + Dyv + Dzw) +
                                     (1.f - omega7) * (C_220 + C_202 + C_022);


            const RealType Cs_220 = 1.f / 3.f * (Eq43RHS + Eq44RHS + Eq45RHS);
            const RealType Cs_202 = 1.f / 3.f * (-Eq43RHS + Eq45RHS);
            const RealType Cs_022 = 1.f / 3.f * (-Eq44RHS + Eq45RHS);

            // Eq 46-48
            const RealType Cs_211 =
                    -1.f / 3.f * (1.f / omega1 - 0.5f) * omega8 * B * rho * DywDzv + (1.f - omega8) * C_211;
            const RealType Cs_121 =
                    -1.f / 3.f * (1.f / omega1 - 0.5f) * omega8 * B * rho * DxwDzu + (1.f - omega8) * C_121;
            const RealType Cs_112 =
                    -1.f / 3.f * (1.f / omega1 - 0.5f) * omega8 * B * rho * DxvDyu + (1.f - omega8) * C_112;
