...
#ifndef COLLISIONCUMD3Q27TURBULENT2017_H
#define COLLISIONCUMD3Q27TURBULENT2017_H

#include "../../traits/LBMTraits.h"

template<typename MODELDATA>
struct CollisionCumD3Q27Turbulent2017 {
    ...
    static void collision(LBMDataPointer &Data, LBMConstantsPointer &Constants) {
        ...
        mutable
        {
            ...
            // Eq 46-48
            const RealType Cs_211 = -1.f/3.f * (1.f / omega1 - 0.5f) * omega8 * B * rho * DywDzv + (1.f - omega8) * C_211;
            const RealType Cs_121 = -1.f/3.f * (1.f / omega1 - 0.5f) * omega8 * B * rho * DxwDzu + (1.f - omega8) * C_121;
            const RealType Cs_112 = -1.f/3.f * (1.f / omega1 - 0.5f) * omega8 * B * rho * DxvDyu + (1.f - omega8) * C_112;
