...
#ifndef OUTLETNEIGHBOUREQUILIBRIUMOMEGA_H
#define OUTLETNEIGHBOUREQUILIBRIUMOMEGA_H

#include "../../traits/LBMTraits.h"

template<typename MODELDATA>
struct OutletNeighbourEquilibriumOmega {
    ...
    static void outletOmega(LBMDataPointer &Data, LBMConstantsPointer &Constants) {
        ...
        auto outletHost_view = Data->meshBoundaryOutletHost;
