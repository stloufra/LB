...
#ifndef D3Q27COLLISIONUNROLLED_H
#define D3Q27COLLISIONUNROLLED_H

#include "../../../traits/LBMTraits.h"

struct D3Q27CollisionUnrolled {
        ...
        if (mesh_view(i.x(), i.y(), i.z()) != 0) {
            ...
            for (int vel = 0; vel < Nvel; vel++) {
                ...
                df_post_view(i.x(), i.y(), i.z(), vel) =
                        ...
                        Mdata.weight[vel] * rho_view(i, j, k) * (1.f + 3.f * Mdata.c[vel][0] * u_view(i, j, k).x()
             + Mdata.c[vel][1] * u_view(i, j, k).y()
             + Mdata.c[vel][2] * u_view(i, j, k).z() + 4.5f * uc * uc - 1.5f * u2)
