...
public:
    ...
    void meshingBoundaryConditionInletUniform(geometryObjectCuboid &cuboid,
        ...
        if(normal_out.x() + normal_out.y() + normal_out.z() != 1){
            printf("Your normal is not tangent to on of the axis.\n");
        }
    ...
    void meshingBoundaryConditionInletParaboloid(geometryObjectCuboid &cuboid,      // location of inlet
    ...
    void meshingBoundaryConditionOutlet(geometryObjectCuboid &cuboid, const Vector& normal_out, RealType density, bool verbose) {
